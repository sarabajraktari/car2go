...
class LogIn implements ModuleInterface {
    ...
    public static function getData($key) {
        ...
        // Ensure flexibleContent is an array and has the 'backround_image' key
        if (is_array($flexibleContent) && isset($flexibleContent['backround_image'])) {
            // Check if 'backround_image' is an array and has the 'url' key
            if (is_array($flexibleContent['backround_image']) && isset($flexibleContent['backround_image']['url'])) {
